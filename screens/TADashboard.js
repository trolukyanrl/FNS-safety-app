      ...
      <View style={styles.bottomNav}>
        ...
        >
          <Ionicons
            ...
            size={24}
            color={activeTab === 'Home' ? BLUE : LIGHT_GREY}
          />
        ...
        >
          <Ionicons
            ...
            size={24}
            color={activeTab === 'Tasks' ? BLUE : LIGHT_GREY}
          />
        ...
        >
          <Ionicons
            name={activeTab === 'Assets' ? 'cube' : 'cube-outline'}
            size={24}
            color={activeTab === 'Assets' ? BLUE : LIGHT_GREY}
          />
          <Text style={[styles.navLabel, activeTab === 'Assets' && styles.navLabelActive]}>
            Assets
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Ionicons
            ...
            size={24}
            color={activeTab === 'Profile' ? BLUE : LIGHT_GREY}
          />
