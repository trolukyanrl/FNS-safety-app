...
export default function SICTasks({ navigation }) {
  ...
  useEffect(() => {
    setActiveTab('Tasks'); // highlight Tasks when coming to this page
  }, []);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.title}>SIC Tasks Page</Text>
        <Text>List all tasks assigned to SIC here...</Text>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  container: { flexGrow: 1, padding: 20, paddingBottom: 100, alignItems: 'center' },
